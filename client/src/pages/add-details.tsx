              ...
              {selectedCleaningDates.length > 0 && (
                <div className="space-y-4">
                  ...
                  {cleaningLocation.trim() && (() => {
                    ...
                    // Same venue: exact match OR location starts with "Ghim Moh " (e.g. Ghim Moh Hawker Centre) but NOT "Ghim Moh Link".
                    const matchLoc = (locName: string) => {
                    ...
                    const matchingItems = items.filter(item =>
                      item.type === 'out' &&
                      item.locations?.some(loc => matchLoc(loc.name))
                    );
